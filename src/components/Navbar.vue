...
<template>
  <nav class="flex items-center h-12 shadow-[0px_5px_10px_rgba(0,0,0,0.2)]">
    <div class="w-[80%] mx-auto flex items-center justify-between">
      <div class="relative">
        ...
        <p
          class="absolute left-1/2 top-1/2 -translate-1/2 text-3xl font-bold italic tracking-wider text-nowrap text-gray-800"
        >
          S-Shop
        </p>
      </div>
